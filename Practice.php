...
?>
  ...
  <div class="w3-bar w3-top w3-large"style="display:none;z-index:4;" id="mySidebar">
    ...
    <div class="w3-sidebar w3-collapse w3-white w3-animate-left" style="display:none;z-index:3;width:300px;"><br>
      ...
      <div class="w3-bar-block">          
        <a href="#" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>&nbsp;&nbsp;&nbsp;Analytic Overview</a>
        <a href="addaccount.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>&nbsp;&nbsp;&nbsp;Register</a>
        <a href="index.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>&nbsp;&nbsp;&nbsp;Log-in</a>
        <a href="sampling.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>&nbsp;&nbsp;&nbsp;Get Mangrove crab Data</a>
  ...
  <div class="w3-main" >
    ...
    <div class="w3-bar w3-large" style="z-index:4; background-color: rgb(2, 51, 19);">
      ...
      <span class="w3-bar-item w3-right" style="color: white;">Mcrab IS</span>
    </div>
